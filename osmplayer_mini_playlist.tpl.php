<div id="<?php print $params['prefix']; ?>mediaplaylist">
  <div id="<?php print $params['prefix']; ?>mediascrollwrapper">
    <div id="<?php print $params['prefix']; ?>mediabusy" class="<?php print $params['prefix']; ?>ui-state-default <?php print $params['prefix']; ?>ui-state-disabled"><img src="<?php print $params['playerURL']; ?>/templates/mini/images/busy.gif" /></div>
